                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <a href="#" target="_blank" title="木庄网络博客源码" >
                            <img src="{{asset('static/content/picture/201610181557196870.jpg')}}" alt="木庄网络博客源码" class="img-responsive"></a>
                    </div>
                    <div class="item">
                        <a href="#" target="_blank" title="专业网站建设" >
                            <img src="{{asset('static/content/picture/201610241227558789.jpg')}}" alt="专业网站建设" class="img-responsive"></a>
                    </div>
                </div>
    ...
    <aside class="sidebar">
        ...
        <div class="widget widget_hot">
            ...
            <ul>
				...
				<img class="thumb" data-original="static/content/picture/201610181739277776.jpg" src="{{asset('static/content/picture/201610181739277776.jpg')}}" alt="用DTcms做一个独立博客网站（响应式模板）"  style="display: block;">
...
{{--        <div class="widget widget_sentence">
            <a href="#" target="_blank" rel="nofollow" title="专业网站建设" >
                <img style="width: 100%" src="{{asset('static/content/picture/201610241224221511.jpg')}}" alt="专业网站建设" ></a>
        </div>
        <div class="widget widget_sentence">
            <a href="#" target="_blank" rel="nofollow" title="MZ-NetBlog主题" >
                <img style="width: 100%" src="{{asset('static/content/picture/ad.jpg')}}" alt="MZ-NetBlog主题" ></a>
        </div>--}}
        <div class="widget widget_sentence">
            <h3>友情链接</h3>
