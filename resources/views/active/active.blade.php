...
<head lang="en">
    ...
    <meta name="author" content="兵哥哥博客">
    <meta name="keywords" content="技术分享">
    <meta name="description" content="技术分享">

    <link rel="stylesheet" type="text/css" href="{{asset('static/active/css/bootstrap.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('static/active/css/build.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('static/active/css/activity.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('static/active/css/login.css')}}" >
    <link rel="stylesheet" type="text/css" href="{{asset('static/active/css/zzsc.css')}}" >
    <link rel="stylesheet" type="text/css" href="{{asset('static/active/css/dlzc.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('static/active/css/nanoscroller.css')}}">
            ...
            <div class="big-pic">
                <a href="article.html" target="_blank" class="transition" title="醒醒吧，腾讯、网易称霸的游戏行业，谁都没机会成为第三">
                    ...
                    <div class="big-pic-content">
                        <h1 class="t-h1">BAT，百度、阿里巴巴、腾讯</h1>
                    </div>
                </a>
            </div>
            <div class="big2-pic big2-pic-index big2-pic-index-top">
                <a href="article.html" class="back-img transition" target="_blank" title="嘘！Facebook 正在上海悄悄寻找办公室">
                    <img class="lazy" src="{{asset('static/active/picture/142618969973.jpg')}}" alt="嘘！Facebook ">
                </a>
                <a href="article.html" target="_blank" title="嘘！Facebook 真的来了！ ">
                    <div class="big2-pic-content">
                        <h2 class="t-h1">嘘！Facebook 真的来了，你知道吗</h2>
                    </div>
                </a>
            </div>
            <div class="big2-pic big2-pic-index big2-pic-index-bottom">
                <a href="article.html" class="back-img transition" target="_blank" title="马云决定建立淘宝">
                    <img class="lazy" src="{{asset('static/active/picture/093433055013.jpg')}}" alt="马云决定建立淘宝">
                </a>
                <a href="article.html" target="_blank" 马云决定建立淘宝>
                    <div class="big2-pic-content">
                        <h2 class="t-h1">马云决定建立淘宝，这是最艰难的决定</h2>
                    </div>
                </a>
            </div>
        </div>--}}
            ...
            <div class="mod-b mod-art" data-aid="213665">
                ...
                <div class="mod-thumb ">
                    <a class="transition" title="你的公司够前沿吗？至少在AI这件事上，多数企业都眼高手低" href="article.html" target="_blank">
                        <img class="lazy" src="{{asset('static/active/picture/111527830443.jpg')}}" alt="你的公司够前沿吗？至少在AI这件事上，多数企业都眼高手低">
                    </a>
                </div>
                ...
                <div class="mob-ctt">
                    <h2><a href="article.html" class="transition msubstr-row2" target="_blank">你的公司够前沿吗？至少在AI这件事上，多数企业都眼高手低</a></h2>
                    <div class="mob-author">
                        <div class="author-face">
                            <a href="article.html" target="_blank"><img src="{{asset('static/active/picture/59_1502432173.jpg')}}"></a>
                        </div>
        ...
        <div class="box-moder moder-rumors-list ">
            ...
            <div class="big2-pic pull-right">
                <a href="#" class="back-img" target="_blank">
                    <img class="lazy" src="{{asset('static/active/picture/105108838520.jpg')}}" alt="">
                </a>
            </div>
            <div class="clear"></div>
        {{--    <ul class="rumorlist">
...
<footer class="footer">
    <div class="container copy-right" style="text-align: center;">
        <span> Copyright 2018 <a href="#"> 哥哥博客 </a> 邮箱:17737157627@163.com <img src="{{asset('static/active/picture/pic.gif')}}" style="width: 45px;"></span>
    </div>
</footer>
<script type="text/javascript" src="{{asset('static/active/js/mouse.js')}}"></script>
